...
`Dida\Event` 是一个Event的管理组件。它是 [宙品科技](http://zeupin.com) 开源的 [Dida框架](http://dida.zeupin.com) 的一个功能组件库。

* Home <https://github.com/zeupin/dida-event>
* Wiki <https://github.com/zeupin/dida-event/wiki>
